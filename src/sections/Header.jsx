...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 flex flex-col items-start">
        <span className="text-2xl font-bold center gap-5 z-40 leading-none pl-1 lg:pl-3">
          <span>Founder of</span> <RedWord text={<FaArrowTrendUp />} />
        </span>
        <h1
          ref={nameRef}
          className="z-20 text-7xl leading-none font-black lg:text-[15vw]"
        >
          ZYNORI
          <RedWord text="X" />
        </h1>
